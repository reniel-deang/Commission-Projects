  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename"><h4><span style="color: white;">&lt;/&gt;</span>CODE<span
            style="color: lightpink;">CRAFT</span></h4></h1>
      </a>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Why <span style="color: rgb(0, 0, 0);">&lt;/&gt;</span>CODE<span
            style="color: lightpink;">CRAFT</span> ?</h2>
        <p>In today’s rapidly evolving tech landscape, mastering programming languages and coding skills is more crucial than ever. CodeCraft offers an innovative and flexible solution for learners at all levels, providing access to top-notch programming tutors through an easy-to-use online platform. Here's why CodeCraft stands out:</p>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <img src="{{asset('homepage-assets/assets/img/about.jpg')}}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 content">
            <h3>Reasons to choose <span style="color: rgb(0, 0, 0);">&lt;/&gt;</span>CODE<span
                style="color: lightpink;">CRAFT</span></h3>
            <ul>
              <li><i class="bi bi-check2-all"></i> <span>At CodeCraft, we understand that every learner has unique needs and goals. Our platform connects you with experienced, professional tutors who offer personalized instruction tailored to your individual learning style and pace. Whether you're a beginner looking to grasp the basics or an advanced coder aiming to refine your skills, our tutors are here to help you succeed.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>With CodeCraft, you gain access to a diverse pool of highly qualified and experienced programming coaches. Each tutor has been carefully vetted to ensure they bring a wealth of knowledge and teaching expertise. From Python to JavaScript, and everything in between, our tutors cover a wide range of programming languages and technologies to match your learning objectives.</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Say goodbye to traditional, static learning methods. Our interactive platform supports real-time communication, allowing you to engage with your tutor through live video sessions, screen sharing, and collaborative coding environments. This dynamic approach enhances your learning experience, making it more engaging and effective.</span></li>
            </ul>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-9 text-center text-xl-start">
            ...
            <p>Students, Teachers and all are very welcome here. If you want to join now, click the button to register</p>
          </div>
